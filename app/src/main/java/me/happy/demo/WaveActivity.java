...
import me.happy.demo.view.wave.WaveView4;

public class WaveActivity extends AppCompatActivity {

    private ImageView imageView;
    private WaveView3 waveView3;
    private WaveView4 waveView4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waveView4 = (WaveView4) findViewById(R.id.wave_view4);
...
//        lp.gravity = Gravity.BOTTOM|Gravity.CENTER;
        ...
        waveView4.setOnWaveAnimationListener(new WaveView4.OnWaveAnimationListener() {
            @Override
            public void OnWaveAnimation(float y) {
